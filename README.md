...
- [X] Fill out and submit the form to add a new transaction. This should add the new transaction to the table **as well as post the new transaction to the backend API for persistence**.
...
- [X] Sort transactions alphabetically by category or description.
- [X] Delete a transaction which will remove it from the table and delete it from the backend.
